...
# The login dance and the core assertion suite live in
# installed_base.pm, shared with the offline diag/verifydisk harness; this
# module adds the profile-specific checks.
